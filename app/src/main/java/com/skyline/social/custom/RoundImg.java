...
public class RoundImg extends ImageView {
     ...
     * 这两个都是画圆的半径
     */
    private int roundWidth = DisplayUtils.dp2px(4);
    private int roundHeight = DisplayUtils.dp2px(4);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            roundWidth = a.getDimensionPixelSize(R.styleable.RoundAngleImageView_roundImgWidth, roundWidth);
            roundHeight = a.getDimensionPixelSize(R.styleable.RoundAngleImageView_roundImgHeight, roundHeight);
        } else {
